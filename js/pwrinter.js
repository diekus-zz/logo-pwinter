...
document.addEventListener('DOMContentLoaded', function() {
    ...
    btnGen.addEventListener('click', function(){
        ...
        var download = document.getElementById('lnkDownload');
        download.href = textfile;
    });
});
